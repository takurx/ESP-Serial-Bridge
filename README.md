...
|---|---|---|---|
| Dec 2025 | ESP32 AP mode, 1 port | ≈ 13,000 bps (drops to 7,000) | ≈ 100,000 bps (stable) |
...
| Feb 2026 | ESP32-S3 ↔ ESP32-S3, 3 ports | 600–45,000 bps | 7,000–13,000 bps |
| Feb 2026 | 3 ports, flow ctrl ON/OFF | ≈ 13,000 bps avg | ≈ 10,000 bps avg |
| **Jun 2026** | **3 ports, buffer opt. applied to client** | **≈ 110,000 bps** | **≈ 115,200 bps** |
...
|---|---|---|---|
| 2025年12月 | ESP32 APモード、1ポート | 約13,000 bps（時々7,000に低下） | 約100,000 bps（安定） |
...
| 2026年2月 | ESP32-S3同士、3ポート同時 | 600〜45,000 bps | 7,000〜13,000 bps |
| 2026年2月 | 3ポート、フロー制御あり/なし | 平均 約13,000 bps | 平均 約10,000 bps |
| **2026年6月** | **3ポート、クライアント側バッファ最適化適用後** | **約110,000 bps** | **約115,200 bps** |
